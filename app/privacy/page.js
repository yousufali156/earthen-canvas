        ...
        <main className="min-h-screen bg-white dark:bg-gray-900">
            <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8 text-gray-800 dark:text-gray-300">
                ...
                <div className="space-y-6 prose prose-lg dark:prose-invert max-w-none">
                    ...
                    <p>
                        If you have any questions or comments about this Privacy Policy, please contact us at: <a href="mailto:privacy@eartencanvas.com" className="text-blue-600 dark:text-blue-400">privacy@eartencanvas.com</a>
                    </p>
                </div>

                {/* Back to Home Button - Centered and Styled */}
