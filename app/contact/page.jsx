...
const Contact = () => {
  ...
  return (
    <>
      ...
      <section
        id="contact"
        className="py-20 text-base-content transition-colors duration-300"
      >
        ...
        <div className="max-w-6xl mx-auto px-4 grid md:grid-cols-2 gap-10">
          ...
          <div className="space-y-5">
            <h1 className="font-bold text-green-500 text-center mb-7 text-4xl bg-base-100 rounded-xl p-4 border border-base-300 shadow">
              Get In Touch
            </h1>
            ...
            <ContactCard
              icon={Mail}
              label="Email"
              value="yousufali.dev@gmail.com"
              link="mailto:yousufali.dev@gmail.com"
            />
            <ContactCard
              icon={Phone}
              label="Phone"
              value="+8801754954385"
              link="tel:+8801754954385"
            ...
            <ContactCard
              ...
              label="GitHub"
              value="Yousuf Ali"
              link="https://github.com/yousufali156"
            ...
            <ContactCard
              ...
              label="LinkedIn"
              value="Yousuf Ali"
              link="https://linkedin.com/in/yousufali156"
              color="text-blue-600"
            />
            <ContactCard
              ...
              label="WhatsApp"
              value="Chat Now"
              link="https://wa.me/8801754954385"
          ...
          <div>
            ...
            <div className="bg-base-100 text-center rounded-xl p-4 mb-6 border border-base-300 shadow">
              <h4 className="font-bold text-green-500">
                Having trouble starting the conversation?
              </h4>
              ...
              <div className="flex flex-wrap justify-center gap-2">
                <button
                  ...
                  onClick={() => generateMessageIdea("Project Inquiry")}
                >
                  Project Inquiry ✨
                </button>
                <button
                  type="button"
                  className="btn btn-sm btn-outline"
                  onClick={() => generateMessageIdea("Collaboration")}
                >
                  Collaboration ✨
                </button>
                <button
                  type="button"
                  className="btn btn-sm btn-outline"
                  onClick={() => generateMessageIdea("General Chat")}
                >
                  General Chat ✨
                </button>
              </div>
            ...
            >
              ...
              <div className="flex flex-col items-center justify-center text-center gap-3">
                ...
                <p className="text-sm max-w-xl">
                  I typically respond to all hiring inquiries and project
                  proposals within 24 hours. For urgent opportunities, feel free
                  to reach out directly via email or WhatsApp.
                </p>
              </div>
            </div>
          </div>
